...
Use only when exact commands or snippets matter.

## Design guidance

- Prefer one strong hero summary and 3-6 sections.
- Start with what the reader needs to know, not background.
- Use flow blocks for relationships, timelines for milestones, and charts for numbers; avoid decorative visuals.
